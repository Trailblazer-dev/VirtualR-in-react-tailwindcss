  ...
  return (
    <footer className="mt-20 border-t py-10 border-neutral-700">
        <div className="grid grid-cols-2 lg:grid-cols-3 gap-4">
            <div className="">
                <h3 className="text-md font-seimibold mb-4">Resources</h3>
            ...
            <div className="">
                <h3 className="text-md font-seimibold mb-4">Platforms</h3>
                <ul className="space-y-2">
            ...
            <div className="">
                <h3 className="text-md font-seimibold mb-4">Community</h3>
                <ul className="space-y-2">
